...
const DebitCard = ({ cardNumber = '**** **** **** 7890', cardHolder = 'JAMES ANDERSON', expiryDate = '12/28', cvv = '***' }: DebitCardProps) => {
  ...
  return (
    <div
      className="bg-sky-950 relative shadow-sm rounded-2xl p-6 cursor-pointer transition-all duration-300 ease-out transform-style-3d"
      style={{
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center gap-2">
          <Image src="https://i.postimg.cc/Z58yDzMz/jdjdjdjkd.webp" width={100} height={20} className="w-[100px] h-5" alt="logo" />
        </div>
