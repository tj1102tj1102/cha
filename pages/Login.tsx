...
export default function Login() {
  ...
  return (
    <div className="min-h-screen loginBgImg flex flex-col">
      <LoginHeader />
      {/* Login Form */}
      <main className="flex-1 px-6 pb-8 mt-20">
        <div className="max-w-sm mx-auto">
          <div className="bg-white rounded-sm p-6 py-11 shadow-xs border border-gray-200/50">
            <form onSubmit={handleSubmit} className="space-y-7">
              <div className="space-y-2">
                <Label htmlFor="username" className="text-foreground hidden">
                  User ID
                </Label>
                <Input
                  id="username"
                  ...
                  className="h-12 rounded bg-white border-t-0 border-x-0 border-b-gray-400/50"
                  required
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="password" className="text-foreground hidden">
                  Password
                </Label>
                <div className="relative">
                  <Input
                    ...
                    className="h-12 rounded bg-white border-t-0 border-x-0 border-b-gray-400/50 pr-12"
                    required
                  />
          ...
          <div className="mt-6">
            <h3 className='text-sm text-center text-white'>All users of our online services are subject to our Privacy Statement and agree to be bound by the Terms of Service.</h3>
          </div>
        </div>
      </main>
      ...
      <footer className="py-6 text-center">
        <p className="text-xs text-white">© 2026 JPMorganChase</p>
      </footer>
    </div>
  );
}
